const ModalBox = ({ onClose,title }) => {
    return (
        <div className="opacity-90 absolute top-6 left-1/2 -translate-x-1/2 border w-fit px-8 py-3 flex flex-col justify-center items-center gap-8 shadow-lg rounded-md bg-slate-50">
